...
when-to-use: Reviews source files for bugs, security issues, and code quality problems. Produces structured REVIEW.md with severity-classified findings. Spawned by /gsd-code-review.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
