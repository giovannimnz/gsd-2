...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/ubuntu/GitHub/forks/gsd-2/.claude
                  → checks /home/ubuntu/GitHub/forks/gsd-2/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done
                  → writes to /home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/hooks/
...
@/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
