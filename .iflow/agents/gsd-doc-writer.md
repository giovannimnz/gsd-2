...
when-to-use: Writes and updates project documentation. Spawned with a doc_assignment block specifying doc type, mode (create/update/supplement), and project context.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
