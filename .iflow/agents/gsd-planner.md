...
<execution_context>
@/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/workflows/execute-plan.md
@/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/templates/summary.md
</execution_context>
...
```bash
INIT=$(node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" history-digest
```
...
@/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/references/thinking-models-planning.md
...
```bash
VALID=$(node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
