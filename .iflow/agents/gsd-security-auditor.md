---
agent-type: gsd-security-auditor
...
when-to-use: Verifies threat mitigations from PLAN.md threat model exist in implemented code. Produces SECURITY.md. Spawned by /gsd-secure-phase.
allowed-tools: 
model: inherit
inherit-tools: true
inherit-mcps: true
