...
Use template from `/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/ubuntu/GitHub/forks/gsd-2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
